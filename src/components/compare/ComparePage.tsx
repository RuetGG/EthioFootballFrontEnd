      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {!showComparison ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">Unable to fetch comparison data. Please try again.</p>
          </div>
        ) : (
          <>
            {/* VS Header */}
            <div className="flex items-center justify-center gap-4 mb-8">
              <span className="text-xl font-semibold text-gray-800">{comparison.comparison_data.team_a.name}</span>
              <div className="bg-green-600 text-white px-6 py-3 rounded-lg font-bold text-lg">
                VS
              </div>
              <span className="text-xl font-semibold text-gray-800">{comparison.comparison_data.team_b.name}</span>
            </div>
